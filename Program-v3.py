...
def cadet(event):
	...
	os.startfile(os.path.join(current_folder, "CADET\\CADET.EXE"))
	start = time.time()
...
def pirates(event):
	global current_folder
	os.startfile(os.path.join(current_folder, "PIRATES\\PIRATES.EXE"))
	start = time.time()
	while time.time() - start <= 100:
		time.sleep(0.1)
...
def dragon(event):
	global current_folder
	os.startfile(os.path.join(current_folder, "DRAGON\\DRAGON.EXE"))
	start = time.time()
	while time.time() - start <= 100:
		time.sleep(0.1)
...
def scientist(event):
	global current_folder
	os.startfile(os.path.join(current_folder, "Mad\\mad.EXE"))
	start = time.time()
	while time.time() - start <= 100:
		time.sleep(0.1)
...
def captain(event):
	global current_folder
	os.startfile(os.path.join(current_folder, "Hero\\hero.EXE"))
	start = time.time()
	while time.time() - start <= 100:
		time.sleep(0.1)
...
def alien(event):
	global current_folder
	os.startfile(os.path.join(current_folder, "Alien\\alien.EXE"))
	start = time.time()
	while time.time() - start <= 100:
		time.sleep(0.1)
...
if not running:
	...
	img_cadet = ImageTk.PhotoImage(Image.open(os.path.join(current_folder, "CADET\\CADET.bmp")).crop((5, 5, 115, 115)))
	img_pirates = ImageTk.PhotoImage(Image.open(os.path.join(current_folder, "PIRATES\\PIRATES.bmp")).crop((5, 5, 115, 115)))
	img_dragon = ImageTk.PhotoImage(Image.open(os.path.join(current_folder, "DRAGON\\DRAGON.bmp")).crop((5, 5, 115, 115)))
	img_scientist = ImageTk.PhotoImage(Image.open(os.path.join(current_folder, "Mad\\Mad.bmp")).crop((5, 5, 115, 115)))
	img_captain = ImageTk.PhotoImage(Image.open(os.path.join(current_folder, "Hero\\Hero.bmp")).crop((5, 5, 115, 115)))
	img_alien = ImageTk.PhotoImage(Image.open(os.path.join(current_folder, "Alien\\Alien.bmp")).crop((5, 5, 115, 115)))
